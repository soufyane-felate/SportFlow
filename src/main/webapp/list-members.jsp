        ...
        <div class="card-body">
            <div class="row search-box">
                ...
                <div class="col-md-6 text-end">
                    <a href="add-member.jsp" class="btn btn-success">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a href="edit-member.jsp?id=<%= member.getId() %>" class="btn btn-sm btn-warning me-2">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="delete-member?id=<%= member.getId() %>" class="btn btn-sm btn-danger"
            ...
            <% if (members.isEmpty()) { %>
            <div class="alert alert-info mt-3">No members found.</div>
            <% } %>
        </div>
    </div>
</div>
